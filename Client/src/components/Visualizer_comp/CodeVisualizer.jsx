        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 rounded-md font-medium flex items-center gap-2 disabled:opacity-50"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 rounded-md font-medium flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
