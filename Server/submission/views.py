...
class ContestSubmissionsAPIView(APIView):
    ...
    def get(self, request, contest_id):  # FIXED: Use contest_id parameter
        ...
        for submission in submissions:
            ...
            if submission.submitted_at:
                sub_data['submitted_at'] = submission.submitted_at.isoformat()
                sub_data['time'] = submission.submitted_at.isoformat()
            
            if submission.judged_at:
                sub_data['judged_at'] = submission.judged_at.isoformat()
    ...
    # submission/views.py - In ContestSubmissionsAPIView class
