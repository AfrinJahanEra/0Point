...
class Account(Document):
    ...
    profile_photo = StringField(null=True)  # Profile photo path/URL
    ...
    # IP and device tracking for ban prevention
    ...
    ip_address = StringField(null=True)  # Current/last IP address
